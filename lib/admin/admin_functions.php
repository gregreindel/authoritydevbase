...
add_filter( 'admin_footer_text', create_function( '$a', 'return \'<span id="footer-thankyou">Site managed by <a href="http://www.authoritydev.com">AuthorityDev</a><span> | Powered by <a href="http://www.wordpress.org">WordPress</a> & Genersis\';' ) );
